...
Usage:
    ...
    python .syspilot/scripts/python/get_need_links.py SYSPILOT_US_CORE_SPEC_AS_CODE --depth 2
    python .syspilot/scripts/python/get_need_links.py SYSPILOT_REQ_CHG_ANALYSIS_AGENT --direction out
