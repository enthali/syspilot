...
- Work from the [public role](../../../docs/Syspilot%20Actors/Syspilot%20Technical%20Writer.md), [process registry](../../../docs/Syspilot%20Processes/index.md), and [active Documentation Foundation contract](../../../docs/changes/documentation-foundation.md).
...
- Present customization as four project-owned levels: Contracts, ontology, documentation matrix, and specialist Actors added alongside the nine Syspilot base roles.
- Treat backend-neutral Syspilot with Sphinx/Sphinx-Needs as the first supported path as intended product direction, even though alternate backend requirements are not yet specified.
