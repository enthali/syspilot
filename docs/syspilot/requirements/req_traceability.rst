...
.. req:: MECE Requirements Review
   :id: SYSPILOT_REQ_TRACE_MECE
   :status: implemented
   :priority: high
   :tags: agent, review, mece
   :links: SYSPILOT_US_TRACE_MECE
...
.. req:: Vertical Traceability Verification
   :id: SYSPILOT_REQ_TRACE_VERTICAL
   :status: implemented
   :priority: high
   :tags: agent, trace, vertical
   :links: SYSPILOT_US_TRACE_VERTICAL
...
.. needtable::
   ...
   :filter: id.startswith('SYSPILOT_REQ_TRACE')
