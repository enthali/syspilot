...
.. req:: Project Memory Agent
   :id: SYSPILOT_REQ_DX_MEMORY_AGENT
   :status: implemented
   :priority: high
   :tags: agent, memory
   :links: SYSPILOT_US_DX_PROJECT_MEMORY
...
.. req:: Agent Selection Menus for User Choices
   :id: SYSPILOT_REQ_DX_AGENT_SELECTION_MENUS
   :status: implemented
   :priority: high
   :tags: agent, ux, developer-experience
   :links: SYSPILOT_US_DX_AGENT_INTERACTION
...
.. req:: Shared Skill Files for Agent Patterns
   :id: SYSPILOT_REQ_DX_AGENT_SKILL_FILES
   :status: implemented
   :priority: high
   :tags: agent, ux, developer-experience, skills
   :links: SYSPILOT_US_DX_AGENT_INTERACTION, SYSPILOT_REQ_DX_AGENT_SELECTION_MENUS
...
.. needtable::
   ...
   :filter: id.startswith('SYSPILOT_REQ_DX')
