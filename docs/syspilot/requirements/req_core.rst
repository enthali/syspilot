...
.. req:: Requirements Management with sphinx-needs
   :id: SYSPILOT_REQ_CORE_SPHINX_NEEDS
   :status: implemented
   :priority: mandatory
...
.. req:: Design Specification with Traceability
   :id: SYSPILOT_REQ_CORE_TRACEABILITY
   :status: implemented
   :priority: mandatory
   :tags: core, traceability
   :links: SYSPILOT_US_CORE_SPEC_AS_CODE, SYSPILOT_REQ_CORE_SPHINX_NEEDS
...
.. req:: File Organization by Domain Type
   :id: SYSPILOT_REQ_CORE_DOMAIN_ORG
   :status: implemented
   :priority: mandatory
   :tags: core, methodology, organization
   :links: SYSPILOT_US_CORE_FILE_ORG
...
.. req:: Level 1 Mirrors Level 0 File Structure
   :id: SYSPILOT_REQ_CORE_L1_MIRROR
   :status: implemented
   :priority: mandatory
   :tags: core, methodology, organization
   :links: SYSPILOT_US_CORE_FILE_ORG, SYSPILOT_REQ_CORE_DOMAIN_ORG
...
.. needtable::
   ...
   :filter: id.startswith('SYSPILOT_REQ_CORE')
