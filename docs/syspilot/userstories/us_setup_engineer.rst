...
.. story:: Setup Manager Agent
   ...
   **Acceptance Criteria:**
   ...
   8. Given a Skill that belongs to an exclusive group is being installed, When a Skill from the same exclusive group is already installed, Then the Setup Agent SHALL reject the installation and report the conflict.
