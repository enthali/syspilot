...
.. spec:: Five-Category Verification
   :id: SYSPILOT_SPEC_VERIFY_CATEGORIES
   :status: implemented
   :links: SYSPILOT_REQ_CHG_VERIFY_AGENT, SYSPILOT_REQ_CORE_TRACEABILITY
...
.. spec:: Verification Report Format
   :id: SYSPILOT_SPEC_VERIFY_REPORT
   :status: implemented
   :links: SYSPILOT_REQ_CHG_VERIFY_AGENT
...
.. spec:: Verification Status Lifecycle
   :id: SYSPILOT_SPEC_VERIFY_STATUS_LIFECYCLE
   :status: implemented
   :links: SYSPILOT_REQ_CHG_VERIFY_AGENT, SYSPILOT_REQ_CHG_FINAL_CHECK, SYSPILOT_SPEC_CHG_ATOMIC_UPDATE
...
.. needtable::
   ...
   :filter: id.startswith('SYSPILOT_SPEC_VERIFY')
