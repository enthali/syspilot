...
.. spec:: Four-Agent Workflow
   :id: SYSPILOT_SPEC_AGENT_WORKFLOW
   :status: approved
   :links: SYSPILOT_REQ_WF_CHANGE_SEQUENCE, SYSPILOT_REQ_CHG_ANALYSIS_AGENT, SYSPILOT_REQ_CHG_IMPL_AGENT, SYSPILOT_REQ_CHG_VERIFY_AGENT, SYSPILOT_REQ_DX_MEMORY_AGENT, SYSPILOT_REQ_CHG_WORKFLOW_STEPS
...
.. spec:: Prompt-Agent Separation
   :id: SYSPILOT_SPEC_AGENT_PROMPT_SEPARATION
   :status: implemented
   :links: SYSPILOT_REQ_CORE_SPHINX_NEEDS, SYSPILOT_REQ_DX_AGENT_SKILL_FILES
...
.. spec:: Agent Interaction via Selection Menus
   :id: SYSPILOT_SPEC_AGENT_INTERACTION
   :status: implemented
   :links: SYSPILOT_REQ_DX_AGENT_SELECTION_MENUS, SYSPILOT_REQ_DX_AGENT_SKILL_FILES
