...
.. spec:: Memory Update Process
   :id: SYSPILOT_SPEC_MEM_UPDATE_PROCESS
   :status: implemented
   :links: SYSPILOT_REQ_DX_MEMORY_AGENT, SYSPILOT_SPEC_AGENT_WORKFLOW
...
.. spec:: Memory Content Rules
   :id: SYSPILOT_SPEC_MEM_CONTENT_CATEGORIES
   :status: implemented
   :links: SYSPILOT_REQ_DX_MEMORY_AGENT
...
.. spec:: copilot-instructions.md Structure
   :id: SYSPILOT_SPEC_MEM_INSTRUCTIONS_STRUCTURE
   :status: implemented
   :links: SYSPILOT_REQ_DX_MEMORY_AGENT
...
.. needtable::
   ...
   :filter: id.startswith('SYSPILOT_SPEC_MEM')
