...
.. spec:: Validation Checklist
   :id: SPEC_RELEASE_004
   :status: implemented
   :links: REQ_RELEASE_004, REQ_RELEASE_005, REQ_RELEASE_006
   ...
   * Future: Automate via GitHub Actions (SPEC_RELEASE_005)
   ...
   **Manual Fallback Process:**
   ...
   4. Create Git tag manually (see SPEC_RELEASE_002)
...
.. spec:: GitHub Actions Workflow
   :id: SPEC_RELEASE_005
   :status: implemented
   :links: REQ_RELEASE_007, REQ_RELEASE_005, REQ_RELEASE_006
   ...
   * Manual fallback available (see SPEC_RELEASE_004)


.. spec:: GitHub Pages Publishing
   :id: SPEC_RELEASE_006
   :status: implemented
   :links: REQ_RELEASE_005
...
.. spec:: Release Agent & Automation
   :id: SPEC_RELEASE_007
   :status: implemented
   :links: REQ_RELEASE_003, REQ_RELEASE_008
   ...
   **Agent Responsibilities:**
   ...
   4. **Validation Guidance:**
      ...
      * Display validation checklist (SPEC_RELEASE_004)
   ...
   **Interaction Model:**
   ...
   .. code-block:: text
      ...
      Agent: [Generates release note entry]
             ...
             ### New Features
             - Install/update mechanism (US_SYSPILOT_012-014)
             - Release process documentation (US_SYSPILOT_015-017)
...
.. needtable::
   ...
   :filter: id.startswith('SPEC_RELEASE')
